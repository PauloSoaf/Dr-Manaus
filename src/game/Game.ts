...
export class Game {
  ...
  constructor(container:HTMLElement){
    ...
    createTerrain(this.worldRoot);this.worldRoot.add(createAirport());this.landmarks=new LandmarkManager(this.worldRoot);
  ...
  private tick=(time:number)=>{
    ...
    this.realCity.update(this.player.position,this.player.velocity,dt);
    ...
    this.traffic?.update(worldDt,this.player.position);
