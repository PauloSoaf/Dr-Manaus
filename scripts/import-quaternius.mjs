...
const names={walk:'Walk_Loop',run:'Sprint_Loop',jump:'Jump_Loop',punch:'Punch_Jab',punchCross:'Punch_Cross',vault:'Jump_Start',roll:'Roll',land:'Jump_Land',swimFwd:'Swim_Fwd_Loop',swimIdle:'Swim_Idle_Loop',swordAttack:'Sword_Attack',spellIdle:'Spell_Simple_Idle_Loop',spellEnter:'Spell_Simple_Enter'};
